...
<img src="02_what_why_intro_files/figure-html//1fu-KfdN2ldOXB49o9zdpurFbVvl1bOh8cfQ3vu0szk4_g3015fd53a67_4_176.png" alt="This chapter will demonstrate how to define data visualization, differentiate between exploratory and expository visualizations, name best practices that can be used to polish a data visualization, and recognize the need for data visualizations." width="100%" style="display: block; margin: auto;" />
...
Possible quality control or transformation steps include
  ...
  * Perform a principal component analysis (PCA) and make related plots (a variance explained elbow plot, embeddings scatter plot, loadings heatmap, etc.).
