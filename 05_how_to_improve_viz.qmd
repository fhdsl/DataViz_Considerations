...
## What do accessibility and ethics have to do with data visualization?
...
The majority of the resource will focus on making visualizations more accessible for audiences who are unfamiliar with your research or who have visual impairments. Accessibility considerations for audiences with motor impairments mostly impact how to prepare interactive visualizations.

::: {.notice}
Resources for ensuring interactive visualizations meet accessibility standards include the WCAG Understanding Documents that provide guides for understanding and implementing the World Wide Web Consortium (W3C) Web Accessibility Initiative (WAI) Web Content Accessibility Guidelines (WCAG). [@]. An example of a relevant guideline is the Keyboard Accessible Guideline (Guidelines 2.1) [@].

The University of Washington provides a guide related to ensuring keyboard accessibility that references the relevant WCAG Guidelines as well. [@]

Harvard University also offers guidance for producing accessible interactive visualizations. [@]
:::
