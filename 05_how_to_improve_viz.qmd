...
### Rules for increasing accessibility for audiences unfamiliar with your research
...
An overly complex plot can be misleading for a number of reasons.
...
An overly complex plot can be misleading for a number of reasons. A takeaway could be obscured because the plot focuses the viewer's attention on another aspect

These reasons include obscuring something because the plot focuses the viewer's attention on another aspect, not separating high density areas or overlapping plot elements, including too much information, or not specifying specialized language such as acronyms or field specific/technical vocabulary.
