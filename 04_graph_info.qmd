...
* **Data Viz Project**: An example of a gallery that describes use cases and provides visual examples from many sources for various plot types is the [Data Viz Project](https://datavizproject.com/)
