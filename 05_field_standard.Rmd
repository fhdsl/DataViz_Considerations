...
**When to use**:
  ...
  * Used to find a ranking or for meta-anlayses or comparing models or odds ratios
...
**Weaknesses**:
  ...
  * For tumor response, there's an accepted notion of waht above or below the baseline means but this might not be true for other applications
