...
```{r fig.align = 'center', out.width = "100%", echo = FALSE, fig.alt = "This chapter will demonstrate how to define data visualization, differentiate between exploratory and expository visualizations, name best practices that can be used to polish a data visualization, and recognize the need for data visualizations."}
...
* Look for missing data
  * How does missing data encoded (e.g., how it appears or what it looks like)? "NA", "NULL", "999", "-1", blank, etc.?
