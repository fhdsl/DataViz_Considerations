...
Exploratory visualizations are made during Exploratory Data Analysis (EDA). These visualizations are made quickly and will not be shared widely outside of your team. EDA and exploratory visualizations are useful for exploring a dataset, data wrangling, sketching any necessary quality control or transformation steps, and validating that you have the necessary data to answer your question.

<u> **Exploring a dataset** steps to consider </u>

1. Look at the beginning of the dataset:
...
1. Look at the end of the dataset:
...
1. Look at the variables you have
  ...
  * Do you know units or other important information like what 0/1 would mean if that's the data within a column?
...
1. Look for trends or correlations
...
1. Perform a PCA (make a variance explained elbow plot, embeddings scatter plot, loadings heatmap, etc.)
1. Do any variables need rounded down, rounded up, log transformed (to spread close values)? How do distributions change after you've done that?
...
Exploratory visualations and EDA allow for researchers to explore their data and validate that it is the correct data to answer the research question. A lot of time will be spent with exploratory visualization and EDA not because you're making any one plot really pretty and very understandable. In fact, you should spend very little time with each plot. The large amount of time instead is the result of making a lot of visualizations and thoroughly exploring the dataset. The time you take at the beginning of an analysis to explore the dataset and truly understand and wrangle what is there, saves a lot of time in the end because you can request more data or make any necessary corrections before you perform the dataset and build up your expository visualizations.
