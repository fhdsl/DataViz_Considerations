...
```{r fig.align = 'center', out.width = "100%", echo = FALSE, fig.alt = "Pictures are worth one thousand words but expository visualization still need words, specifically readable and informative text such as a declarative title that states the conclusion, informative axes labels, a legend or some sort of color labeling, and a descriptive caption that includes context on the data source and handling"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1fu-KfdN2ldOXB49o9zdpurFbVvl1bOh8cfQ3vu0szk4/edit?slide=id.g3b15b578b21_13_5#slide=id.g3b15b578b21_13_5")
```
